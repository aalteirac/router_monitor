...
function create(options) {
  return new huawei(options);
}
var exposed = huawei.prototype;
...
//add pagination
exposed.getSMSList = function (box,tok,page=1) {
  return new Promise(async (resolve,reject)=>{
      var token=await exposed.getToken(tok)
...
exposed.getMonthStatistics = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.getSignal = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.getStatus = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.getTrafficStatistics = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.getBasicSettings = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.getInformation = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.getProfiles = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.getCurrentPLMN = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.getLedStatus = function (token, callback) {
  return new Promise(async (resolve,reject)=>{
...
exposed.setLedOn = function (token, value, callback) {
  return new Promise(async (resolve,reject)=>{
    var uri = url('http://', this.options.gateway, '/api/led/circle-switch');
    var body = {
      ledSwitch: value ? 1 : 0
